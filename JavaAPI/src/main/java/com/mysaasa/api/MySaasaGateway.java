...
public interface MySaasaGateway {
    ...
    Call<com.mysaasa.api.responses.GetBlogPostByIdResponse> getBlogPostById(@Field("id")long id);


    @FormUrlEncoded
    @POST("UserApiService/createUser")
    Call<com.mysaasa.api.responses.CreateUserResponse> createUser(@Field("identifier")String identifier, @Field("password")String password);
    ...
    Call<com.mysaasa.api.responses.PostReplyResponse> postReply(@Field("parent_comment_id")long parent_comment_id, @Field("comment")String comment);
    ...
    Call<com.mysaasa.api.responses.GetSessionResponse> getSession();
    ...
    Call<com.mysaasa.api.responses.GetProductCategoriesResponse> getProductCategories();
    ...
    Call<com.mysaasa.api.responses.GetTopLevelBlogCommentsResponse> getTopLevelBlogComments(@Field("id")long id, @Field("count")int count);
